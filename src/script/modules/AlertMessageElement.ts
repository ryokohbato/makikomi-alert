...
const replyMember__query
  = `.css-1dbjc4n.r-1wbh5a2.r-rsyp9y.r-1pjcn9w.r-htvplk.r-1udh08x.r-1potc6q
    .css-1dbjc4n.r-18kxxzh
    + .css-1dbjc4n.r-1iusvr4.r-16y2uox
    > .css-18t94o4.css-901oao.r-16y2uox.r-1tl8opc.r-16dba41.r-ad9z0x.r-bcqeeo.r-glunga.r-qvutc0
    > .css-901oao.css-16my406.r-1tl8opc.r-ad9z0x.r-bcqeeo.r-qvutc0
    > .css-901oao.css-16my406.r-1tl8opc.r-ad9z0x.r-bcqeeo.r-qvutc0`;

  const replyBox = '.css-1dbjc4n.r-1wbh5a2.r-rsyp9y.r-1pjcn9w.r-htvplk.r-1udh08x.r-1potc6q';

  const svg_code__alert
    = `<g>
        <path class="st0" d="M437.014,74.978C390.77,28.696,326.608-0.014,256,0C185.393-0.014,121.222,28.696,74.977,74.978
          ...
          C312.111,53.112,362.667,75.763,399.474,112.526z"></path>
        <path class="st0" d="M246.681,303.592c0.312,2.075,1.349,4.067,3.104,5.986c1.748,1.911,3.822,2.866,6.215,2.866
          ...
          c0,4.31,0.156,7.888,0.474,10.748L246.681,303.592z"></path>
        <path class="st0" d="M256,390.792c8.118,0,14.962-2.778,20.548-8.362c5.57-5.563,8.356-12.422,8.356-20.541
          ...
          c-5.578,5.585-8.356,12.348-8.356,20.318c0,7.637,2.778,14.407,8.356,20.303C241.029,387.934,247.882,390.792,256,390.792z"></path>
      </g>`;

  const svg_code__check
    = `<g>
...
export const alertMessageElement = function(): string
{
  ...
  const countAllIndex = function(target: string, search: string): number
  {
    ...
    while(target.indexOf(search, temp) != -1)
    {
      temp = target.indexOf(search, temp) + 1;
      count++;
    }
